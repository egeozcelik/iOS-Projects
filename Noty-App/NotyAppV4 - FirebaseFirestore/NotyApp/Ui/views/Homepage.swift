...
class Homepage: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        _ = homepageViewModel.bannerList.subscribe(onNext: { list in
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        let rnd = Int.random(in: 1..<5)
        if rnd == 3{
            let index = Int.random(in: 0..<(bannerList.count))
            mainLabel.text = bannerList[index].mainLabel
            subLabel.text = bannerList[index].subLabel
        }
